...
jQuery(function($) {
    ...
    var $theWindowSize = $(this).width();
		if ($theWindowSize < 480) { 
			$(".cd-headline .cd-words-wrapper > b").addClass("centered").css("white-space","normal");
		} else {
			$(".cd-headline .cd-words-wrapper > b").addClass("centered").css("white-space","nowrap");
		}
		...
		if($theWindowSize < 992) {
			$(".layout-boxed #sp-header").css("width","100%");
			$(".layout-boxed #sp-header #sp-logo").css("width","65%");
		} 
		else {
			$(".layout-boxed #sp-header #sp-logo").css("width","auto");
			$(".cd-headline .cd-words-wrapper > b").css("white-space","nowrap");
		}
    });
	...
	if ($("body.sticky-header").length > 0) {	
		...
		$("#offcanvas-toggler + #offcanvas-toggler").remove();
...
jQuery(function($) {$(window).load(function(){$('.match-height').matchHeight();});});
