...
if (isset($_POST['submit'])) {
    $admin = R::dispense('distr');
    $admin->distric = $_POST['title'];
...
//    $admin->date = date('d-m-y');
    ...
    print ("<script>window.alert('Province Successfully Update!!!')</script>");
    print ("<script>window.location.assign('categories.php')</script>");
}
if(@$_GET['action']){
    $todo_id=   $_GET['id'];
    $trash = R::findOne('distr','id =?',[$todo_id]);
    R::trash($trash);
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> All Provinces</h3>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        ...
                        <a href="#add" data-toggle="modal" class="btn btn-default btn-sm">add new Province</a>
                            ...
                            <table class="table">
                                ...
                                if ($in!=null) {
                                    ...
                                    foreach ($in as $iny) {
                                        ?>
                                        <tr>
                                            <td class="review-summary-name"><?php  echo  $iny->distric ?></td>
                                            <td class="review-summary-action">
                                                ...
                                                <a href="#update<?php echo $iny->id; ?>" class="btn btn-outline-violate btn-xs mr10" data-toggle="modal">Edit</a>
                                            ...
                                            <div class="modal-dialog modal-confirm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="categories.php?action=delete&id=<?php echo $iny->id; ?>" type="button" style="color: white" class="btn btn-danger ">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="update<?php echo $iny->id; ?>" class="modal fade">
                                            <div class="modal-dialog modal-confirm">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input id="title" name="title" value="<?php echo $iny->distric; ?>" type="text" placeholder="Province Name" class="form-control ">
                                                                            <input id="title" name="id" value="<?php echo $iny->id; ?>" type="hidden" placeholder="Province Name" class="form-control ">
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="venue-form-info card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label class="control-label" for="title">Province Name</label>
                                        <input id="title" name="title" type="text" placeholder="Province Name" class="form-control ">
                                    </div>
                                </div>
