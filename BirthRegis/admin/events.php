                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> Events</h3>
                            <?php
//                            $max_time = ini_get("post_max_size");
//                            echo $max_time;
                            ?>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        ...
                        <a href="addEvents.php" class="btn btn-default btn-sm">add new Event</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7 col-lg-5 col-md-7 col-sm-12 col-12">
                                                <div class="dashboard-list-content">
                                                    ...
                                                    <p>Start Date:<b> <?php  echo  $iny->startdate ?></b>     End Date: <b><?php  echo  $iny->enddate ?></b></p>
                                                    <p>Time:<b> <?php  echo  $iny->starttime ?></b>  To: <b><?php  echo  $iny->endtime ?></b></p>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                                                <div class="dashboard-list-btn">
                                                    <a href="editEvent.php<?php echo '?id=' . $iny->id; ?>" class="btn btn-outline-violate btn-xs mr10">edit</a>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="review-user">
                                                    ...
                                                    <div class="user-meta">
                                                        ...
                                                        <span class="user-review-date"><?php  echo  $iny->date ?></span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            ...
                                                            <div class="review-list">
                                                                <div class="review-for">Event Title</div>
                                                                <div class="review-number"><?php  echo  $iny->title ?></div>
                                                            </div>
                                                            <!-- /.review-list -->
                                                            <!-- review-list -->
                                                            <div class="review-list">
                                                                <div class="review-for">Start Date</div>
                                                                <div class="review-number"><?php  echo  $iny->startdate ?></div>
                                                            </div>
                                                            <div class="review-list">
                                                                <div class="review-for">End Date</div>
                                                                <div class="review-number"><?php  echo  $iny->enddate ?></div>
                                                            </div>
                                                            <!-- /.review-list -->
                                                            <!-- review-list -->
                                                            <div class="review-list">
                                    ...
                                    <div class="modal-dialog modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="delete-event.php<?php echo '?id='.$iny->id; ?>" type="button" style="color: white" class="btn btn-danger ">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
