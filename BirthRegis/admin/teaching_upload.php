...
$valid_extensions = array("mp3", "ogg", "flac","amr"); // valid extensions
$path = 'uploads/audio/'; // upload directory
...

{
    ...
    if(in_array($ext, $valid_extensions))
    {
        ...
        if(move_uploaded_file($tmp,$path))
        {
            ...
            $insert = $db->query("INSERT products (name,title,vidio,profile,description,date) VALUES ('".$name."','".$title."','".$path."','".$filename."','".$des."','".$date."')");
        }
    ...
    else
    {
        ...
        print ("<script>window.location.assign('addTeaching.php')</script>");
    }
}
?>