            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> About</h3>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        ...
                        <a href="addAbout.php" class="btn btn-default btn-sm">add new</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7 col-lg-5 col-md-7 col-sm-12 col-12">
                                                <div class="dashboard-list-content">
                                                    <h3 class="mb0"><a href="#" class="title"><?php echo $iny->name ?></a></h3>
                                                    <p><b> <?php  echo  $iny->title ?></b>  </p>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                                                <div class="dashboard-list-btn">
                                                    <a href="editAbout.php<?php echo '?id=' . $iny->id; ?>" class="btn btn-outline-violate btn-xs mr10">edit</a>
                                                ...
                                                <div class="review-descriptions">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            ...
                                                            <div class="review-list">
                                                                <div class="review-for">Contact</div>
                                    ...
                                    <div class="modal-dialog modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="delete-about.php<?php echo '?id='.$iny->id; ?>" type="button" style="color: white" class="btn btn-danger ">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
