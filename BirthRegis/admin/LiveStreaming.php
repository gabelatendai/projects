            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> LiveStreaming</h3>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        ...
                        <a href="addLiveStreaming.php" class="btn btn-default btn-sm">add new LiveStreaming</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7 col-lg-5 col-md-7 col-sm-12 col-12">
                                                <div class="dashboard-list-content">
                                                    ...
                                                    <p> <a href="<?php  echo  $iny->link ?>"> Link</a>  </p>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                                                <div class="dashboard-list-btn">
                                                    <a href="editLivestreaming.php<?php echo '?id=' . $iny->id; ?>" class="btn btn-outline-violate btn-xs mr10">edit</a>
