            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> Assemblies</h3>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        ...
                        <a href="addAssembly.php" class="btn btn-default btn-sm">add new Assembly</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7 col-lg-5 col-md-7 col-sm-12 col-12">
                                                <div class="dashboard-list-content">
                                                    ...
                                                    <p>Location:<b> <?php  echo  $iny->location ?></b></p>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                                                <div class="dashboard-list-btn">
                                                    <a href="editAssembly.php<?php echo '?id=' . $iny->id; ?>" class="btn btn-outline-violate btn-xs mr10">edit</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            ...
                                                            <div class="review-list">
                                                                <div class="review-for">Assembly Name</div>
                                                            ...
                                                            <div class="review-list">
                                                                ...
                                                                <div class="review-number"><?php  echo  $iny->location ?></div>
                                                            </div>
                                                            <div class="review-list">
                                                                <div class="review-for">Contact Details</div>
                                                                <div class="review-number"><?php  echo  $iny->contact ?></div>
                                                            </div>
                                                            <!-- /.review-list -->
                                                            <!-- review-list -->
                                                            <div class="review-list">
                                    ...
                                    <div class="modal-dialog modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="delete-assembly.php<?php echo '?id='.$iny->id; ?>" type="button" style="color: white" class="btn btn-danger ">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
