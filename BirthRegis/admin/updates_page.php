...
if(isset($_GET['visibility_mode']))
{
    ...
    $sql = "Update Updatess SET status =".$visibility_mode." WHERE id=".$rid;
    $mysqli->query($sql);
}
?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> Updatess</h3>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        ...
                        <a href="addUpdates.php" class="btn btn-default btn-sm">add new Updates</a>
                                    ...
                                    <div class="modal-dialog modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="delete-Updates.php<?php echo '?id='.$iny->id; ?>" type="button" style="color: white" class="btn btn-danger ">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
