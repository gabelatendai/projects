                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label class="control-label" for="title">Assembly Title</label>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <input id="title" value="<?php echo $contact ?>" name="contact" type="text" placeholder="Contact details" class="form-control ">
                                        </div>
                                    </div><div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="form-group">
                                            <label class="control-label" for="title">Location</label>
                                            <input id="title" value="<?php echo $location ?>" name="location" type="text" placeholder="Location" class="form-control ">
                                        </div>
                                    </div>
