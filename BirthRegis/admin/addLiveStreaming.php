...
if (isset($_POST['submit'])) {
    ...
    move_uploaded_file( $filetmp,$filepath);
                ...
                $admin = R::dispense('livestreaming');
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title">Add New LiveStreaming</h3>
                            <p>Lists present multiple line items vertically as a single continuous element.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header"> <h4 class="mb0">About LiveStreaming</h4></div>
                    <div class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label class="control-label" for="title">LiveStreaming Title</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="description"  placeholder="Write short text ">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="url" name="link"  placeholder="url link ">
