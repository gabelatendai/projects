...
if(isset($_GET['visibility_mode']))
{
    ...
    $sql = "Update services SET status =".$visibility_mode." WHERE id=".$id;
    $mysqli->query($sql);
}
?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> services</h3>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        ...
                        <a href="addservices.php" class="btn btn-default btn-sm">add new Service</a>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-2 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="dashboard-list-img"><a href="#">
                                                        <img src="uploads/cat/<?php echo $iny['profile'] ?>" style="height: 100px" alt="" class="img-fluid">
                                                    </a></div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="dashboard-list-btn">
                                                    ...
                                                    <a href="editService.php<?php echo '?id=' . $iny['id']; ?>" class="btn btn-outline-violate btn-xs mr10">edit</a>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="review-user">
                                                    <div class="user-img"> <img src="uploads/cat/<?php echo $iny['profile'] ?>" style="height: 300px" alt="star rating jquery" class="rounded-circle"></div>
                                                    <div class="user-meta">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            ...
                                                            <div class="review-list">
                                                                <div class="review-for">Service Name</div>
                                                            ...
                                                            <!-- review-list -->
                                                            <div class="review-list">
                                                                <div class="review-for">About Service</div>
                                                                <div class="review-number"><?php  echo  $iny['description'] ?></div>
                                                            </div>
                                                        </div>
                                                        <!-- /.review-list -->
                                                    </div>
                                    ...
                                    <div class="modal-dialog modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="delete-services.php<?php echo '?id='.$iny['id']; ?>" type="button" style="color: white" class="btn btn-danger ">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
