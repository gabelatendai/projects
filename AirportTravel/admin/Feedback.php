...
//include 'config.php';
    ...
    mysqli_query($mysqli,"delete from feedback where id='$id'")or die("query is incorrect...");
        ...
        <div class="dashboard-content">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            <h3 class="dashboard-page-title"> Contact Page Feedback</h3>
                ...
                <div class="dashboard-vendor-list">
                        ...
                        <?php
                        $in = mysqli_query($mysqli, " SELECT * FROM feedback");

//                        while (  $r = mysqli_fetch_assoc($result))
//                        if ($in!=null) {

                            while($iny=mysqli_fetch_assoc($in)) {
                                ?>
                                <tbody>
                                <tr>
                                    <td><?php echo $iny['name'] ?>  </td>
                                    <td class="estimate-total"><span class="total-amount"> <?php echo $iny['email'] ?>  </span></td>
                                    <td class="actual-total"><span class="total-amount"><?php echo $iny['mobile'] ?>  </span></td>
                                    <td class="paid-total"><span class="total-amount"><?php echo $iny['subject'] ?>  </span></td>
                                    <td ><?php echo $iny['message'] ?>  </td>
                                    <td class="pending-total"><span class="total-amount"><?php echo $iny['date_created']?>  </span></td>
                                    <td>
