...
if(isset($_GET['delete'])){
    ...
    mysqli_query($mysqli,"delete from cars where id='$id'")or die("query is incorrect...");
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="dashboard-page-header">
                        <h3 class="dashboard-page-title">Car Rental</h3>
                                ...
                                <div class="modal-dialog modal-confirm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="cars.php?delete=delete&<?php echo 'id='.$iny['id']; ?>" type="button" style="color: white" class="btn btn-danger ">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="send<?php echo $iny['id']; ?>" class="modal fade">
                                <div class="modal-dialog modal-confirm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                            <a href="cars.php?send=send&<?php echo 'id='.$iny['id']; ?>" type="button" style="color: white" class="btn btn-secondary ">Send Mail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
